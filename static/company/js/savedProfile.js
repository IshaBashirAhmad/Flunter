...
let savedProfilesUrl = '/save/candidate?perPage=20&search=';
...
window.addEventListener('load', getSavedProfilesList(savedProfilesUrl));
...
function searchForm(event) {
    ...
    savedProfilesUrl = setParams(savedProfilesUrl, 'search', data.keywords);
...
function getPage(page) {
    ...
    savedProfilesUrl = setParams(savedProfilesUrl, 'page', page);
    getSavedProfilesList(savedProfilesUrl);
}